...
type ``Id Tests`` ()=
    ...
    [<Test>] 
    member x.``Print of One Leaf should print 1`` ()=
        Assert.AreEqual(print One, "1")

    [<Test>] 
    member x.``Print of Node should print values separated by comma`` ()=
        Assert.AreEqual(print (Node(Zero, One)), "(0,1)")

    [<Test>] 
    member x.``Print of Complex Node should print values separated by comma`` ()=
